    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-5">
          ...
          <div class="col-md-12 border-bottom pb-10">
            <p>{{ this.currentProduct.description }}</p>
          </div>
          <div class="col-md-12 rounded-5 bg-gray300 p-6 mt-10">
            <div class="fs-11 mb-2">{{ parseInt(this.currentProduct.price).toFixed(0)
              .replace(/\B(?=(\d{3})+(?!\d))/g, ",") }} 元</div>
            <div class="fs-5 mb-6">原價 <del>{{ parseInt(this.currentProduct.origin_price).toFixed(0)
